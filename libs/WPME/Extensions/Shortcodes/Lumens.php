...
class Lumens extends Base
{
    ...
    public function __construct()
    {
        ...
        $this->setButtonTitle('Class List Widget');
        $this->setModalTitle('Class List Widget');
        $this->setButtonIcon('dashicons-list-view');
    }
    ...
    public function getJavascriptPlaceHolder()
    {
        ...
        <script type="text/javascript">
            this.setContent(
                '<div class="loading-placeholder gn-sc-plc placeholder-lumens" title="Class List Widget">' +
