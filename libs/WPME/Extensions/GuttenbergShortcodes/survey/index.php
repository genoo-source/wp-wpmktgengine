...
register_block_type( 'wpme/wpme-survey-block', array(
    'attributes' => array(
        'id' => array(
            'type' => 'integer'
        ),
    ),
    'editor_script'   => 'wpme-survey-block', // The script name we gave in the wp_register_script() call.
    'render_callback' => 'wpme_survey_block_render',
) );
 ...
 */
function wpme_survey_block_render($attributes) {
    $default = array(
        'id' => '',
    );
    ...
    if(defined('REST_REQUEST') && REST_REQUEST){
        return "<div class=\"loading-placeholder gn-sc-plc placeholder-form\" title=\"form\"><div class=\"dashicons dashicons-media-spreadsheet media-spreadsheet\"></div></div>";
    } else {
        // This is regular page
        $shortcodeName = apply_filters('genoo_wpme_survey_shortcode', 'WPMKTENGINESurvey');
