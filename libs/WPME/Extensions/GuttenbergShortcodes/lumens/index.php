...
register_block_type( 'wpme/wpme-lumens-block', array(
    'attributes' => array(
        'id' => array(
            'type' => 'integer'
        ),
    ),
    'editor_script'   => 'wpme-lumens-block', // The script name we gave in the wp_register_script() call.
    'render_callback' => 'wpme_lumens_block_render',
) );
 ...
 */
function wpme_lumens_block_render($attributes) {
    $default = array(
        'id' => '',
    );
    ...
    if(defined('REST_REQUEST') && REST_REQUEST){
        return "<div class=\"loading-placeholder gn-sc-plc placeholder-form\" title=\"lumens\"><div class=\"dashicons dashicons-media-spreadsheet media-spreadsheet\"></div></div>";
    } else {
        // This is regular page
        $shortcodeName = 'genooLumens';
