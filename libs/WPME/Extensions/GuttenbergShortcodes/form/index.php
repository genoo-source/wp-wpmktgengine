...
register_block_type( 'wpme/wpme-form-block', array(
    'attributes' => array(
        'id' => array(
            'type' => 'integer'
        ),
    ...
    'editor_script'   => 'wpme-form-block', // The script name we gave in the wp_register_script() call.
    'render_callback' => 'wpme_form_block_render',
) );
 ...
 */
function wpme_form_block_render($attributes) {
    $default = array(
        'id' => '',
        'theme' => '',
        'confirmation' => 'false',
    ...
    if(defined('REST_REQUEST') && REST_REQUEST){
        return "<div class=\"loading-placeholder gn-sc-plc placeholder-form\" title=\"form\"><div class=\"dashicons dashicons-feedback feedback\"></div></div>";
    } else {
        // This is regular page
        $shortcodeName = apply_filters('genoo_wpme_form_shortcode', 'WPMKTENGINEForm');
